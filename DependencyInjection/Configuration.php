            ...
            ->children()
                ->arrayNode('templates')
                    ...
                    ->children()
                        ...
                        ->scalarNode('form_elements')->defaultValue('CtrlRadBundle:partial:_form_elements.html.twig')->end()
                        ->scalarNode('form_buttons')->defaultValue('CtrlRadBundle:partial:_form_buttons.html.twig')->end()
                    ->end()
                ->end()
            ->end();
    }
